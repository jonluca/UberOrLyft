...
<html lang="en">
<head>
    <title>Code coverage report for src/Lyft.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> Lyft.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  getAccessToken() {
    return rp({
      ...
      .catch(<span class="fstat-no" title="function not covered" >function(</span>err) {
